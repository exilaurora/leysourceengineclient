...
/**
 * @file valve/buf.h
 * @brief Реализация битового буфера для сериализации/десериализации (bf_read/bf_write).
 *
 * Используется для упаковки/распаковки данных в битовом виде при сетевой передаче.
 * Файл взят из исходников Valve с локальными адаптациями.
 */
